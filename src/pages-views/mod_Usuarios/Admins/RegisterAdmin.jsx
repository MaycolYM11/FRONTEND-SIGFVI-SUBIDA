...
export const RegisterAdmin = ({ isOpen, closeModal, reConsulta }) => {
  const agregarRegistro = () => {
    axios
      .post('https://backend-sigfvi-subida-iota.vercel.app/usuario/Create', {
        id: numid,
        tipoid: tipoid,
        name1: name1,
        name2: name2,
  ...
  function Verificar_password() {
    ...
    if (Inpassword.length < 8) {
      ...
      document.getElementById('wrongpass').innerHTML =
        'La contraseña debe ser mayor a 8 caracteres para preservar la seguridad';
      con = false;
    } else {
      document.getElementById('wrongpass').innerHTML = '';
    }
  ...
  function Verificar_registro() {
    ...
    if (con) {
      axios
        .get(
          `https://backend-sigfvi-subida-iota.vercel.app/usuario/usuario_empleado/${numid}`
        )
        .then((response) => {
        ...
        .catch((error) => {
          console.error(
            'Error al verificar el número de identificación:',
            error
          );
        });
    }
    ...
    <div className="register-container">
      <div className="fondo-register">
        ...
        <div class="container__Main-register">
          <div class="titulo">
            <h1 className="main-title">Registar Gerente</h1>
          </div>
          <form className="datos-contenido">
            ...
            <span>
              ...
              <input
                ...
                onKeyUp={Verificar_password}
                onBlur={Verificar_password}
            ...
            <span>
              ...
              <input
                ...
                onKeyUp={Verificar_passwordcheck}
                onBlur={Verificar_passwordcheck}
              />
              <p id="wrongcheck"></p>
            </span>
            <span class="bloc">
